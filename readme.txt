...
Please remember, all these steps need to be adjusted to your specific application and setup. 
Note:

Replace <Deployment.yaml>, <Service.yaml>, <PersistentVolumeClaim.yaml> with your actual file names.
